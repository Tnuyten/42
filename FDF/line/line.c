...
/*   Updated: 2022/05/19 19:58:46 by tnuyten          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void image_draw_line_bresenham(t_data img, t_coord start, t_coord end, int color);
...
void image_draw_line(t_data img, t_coord start, t_coord end, int color)
{
	...
	// 	return;
	image_draw_line_bresenham(img, start, end, color);
	// int dx;
	// int dy;
	//
	...
	// 	return;
	// if(dx == 0)
	// 	draw_vertical_line(img, start, end, color);
	// else if(dy == 0)
	// 	draw_horizontal_line(img, start, end, color);
	// else if(dx >= dy)
